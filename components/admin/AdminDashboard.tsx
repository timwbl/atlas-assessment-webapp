  ...
  return (
    <div className="admin-dashboard">
      ...
      <section className="admin-stat-grid" aria-label="Admin-Kennzahlen">
        <Stat label="Übungen" value={data.assessments} loading={loading} />
      ...
      <div className="admin-dashboard-grid">
        ...
        <section className="card admin-panel">
          ...
          <div className="admin-quick-grid">
            <button type="button" onClick={() => onNavigate("assessments")}>Übung verwalten</button>
            ...
            <button type="button" onClick={() => onNavigate("users")}>Fortschritt der Nutzer:innen öffnen</button>
      ...
      <section className="card admin-panel">
        ...
        <div className="admin-system-grid">
          ...
          <div><strong>Lokaler Editor</strong><span>Änderungen an Übungen werden weiterhin als JSON exportiert.</span></div>
        </div>
      </section>
    </div>
  );
