...
export function MobileNav() {
  ...
  return (
    <nav className="mobile-nav" aria-label="Mobile Navigation">
      ...
      <Link className={pathname.startsWith("/assessments") || pathname.startsWith("/assessment/") ? "mobile-nav-item is-active" : "mobile-nav-item"} href="/assessments" prefetch={false}>
        <span className="mobile-nav-icon" aria-hidden="true">▤</span>
